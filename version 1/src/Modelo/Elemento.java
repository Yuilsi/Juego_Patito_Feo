...
public abstract class Elemento implements Dibujable, Animado {
	...
	public boolean getMisionCumplida(){
		return this.isMisionCumplida();
	}
	...
	public boolean isMisionCumplida() {
		return misionCumplida;
	}

	public void setMisionCumplida(boolean misionCumplida) {
